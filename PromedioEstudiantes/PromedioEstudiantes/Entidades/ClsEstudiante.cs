...
namespace PromedioEstudiantes.Entidades
{
    class ClsEstudiante
    {
        ...
        public ClsEstudiante(string nombre, string apellido, double lab1, double lab2, double lab3, double parcial1, double parcial2, double parcial3, double promedioFinal, double notaFinal, double periodo1, double periodo2, double periodo3)
        {
            this.nombre = nombre;
